...
case1 = {'label': 'Azure A9'}
keys = ['latency', 'bandwidth']
directory = os.path.join(root_dir, 'azure-A9cluster', 'osubenchmarks')
series = []
for i in range(1, 6):
  tmp_case = {}
  for key in keys:
...
get_average(case1, series, keys=keys)

case2 = {'label': 'Azure NC24r (Batch)'}
keys = ['latency', 'bandwidth']
...
plot_latency_bandwidth([case1, case2, case3],
                       save=save_path)
