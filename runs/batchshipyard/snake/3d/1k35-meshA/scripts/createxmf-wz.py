"""
Creates an XMF file for the z-component of the vorticity field.
"""
...
config['grid file'] = os.path.join(config['directory'],
                                   'grids', 'wz.h5')
config['grid size'] = (1070, 1071, 40)
config['variables'] = ['wz']
config['states'] = [i for i in range(100000, 200000 + 1, 2000)]
config['time step size'] = 1.0E-03
config['time correction'] = 0.0
