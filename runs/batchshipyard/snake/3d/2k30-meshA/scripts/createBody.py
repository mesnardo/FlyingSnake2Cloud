...
cross-section at angle-of-attack 30 degrees.

We read the coordinates from the file `snakeAoA30.txt`, which contains the 2D
...
We save the boundary coordinates into the file `flyingSnake3dAoA30.body`.
"""

from snake.geometry import Geometry2d


section = Geometry2d(file_path='snakeAoA30.txt')
section.discretization(ds=0.008)
cylinder = section.extrusion(limits=(0.0, 3.2), ds=0.08)
cylinder.write(file_path='flyingSnake3dAoA30.body')
